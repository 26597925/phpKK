...
class Aes
{
    ...
    public function set($z, $mode = 'ECB', $iv = null)
    {
...
//$aes = new Aes(array(49,50,51,52,53,54,55,56,57,48,49,50,51,52,53,54), "ECB", null);
//$text = base64_decode('HchNbeTjRf2XmpVD447bOg==');
